...
<title>User - List Products</title>
<link rel="stylesheet"
...
<body>
	...
	<section class="container-fluid p-4">
				...
				<table class="table table-striped table-hover" border="1" cellspacing="5px" cellpadding="5px">
	                ...
	                <c:forEach items="${products }" var="product">
	                    <tr>
	                        ...
	                        <td>${product.cost }</td>
	                        <td>
	                            <a class="btn btn-sm btn-primary" href="${pageContext.request.contextPath }/user/add-to-cart/${product.id}">ADD TO KIT</a>
	                        </td>
	                    </tr> 
	                </c:forEach>
				</table>
		...
		<form:form action="${pageContext.request.contextPath }/user/show-kit" method="POST">
			<button class="btn btn-primary">Show Kit</button>
		</form:form>
